...
public class UserControllerTest {
    ...
    void 사용자는_특정_유저의_정보를_개인정보는_소거된채_전달_받을_수_있다() throws Exception {
        ...
        mockMvc.perform(get("/api/users/1"))
                ...
                .andExpect(jsonPath(("$.email")).value("ambosing_@naver.com"))
                .andExpect(jsonPath(("$.nickname")).value("ambosing"))
    ...
    void 사용자는_인증_코드로_계정을_활성화_시킬_수_있다() throws Exception {
        ...
        UserEnity userEntity = userJpaRepository.findById(2L).get();
    ...
    void 사용자는_내_정보를_수정할_수_있다() throws Exception {
        ...
        mockMvc.perform(put("/api/users/me")
                ...
                .andExpect(jsonPath("$.id").value(1))
                .andExpect(jsonPath(("$.email")).value("ambosing_@naver.com"))
                .andExpect(jsonPath(("$.nickname")).value("ambosing-n"))
